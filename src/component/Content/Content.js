...
class Content extends Component {
    render() {
      ...
      return (
        ...
        Donec et placerat erat, vestibulum pulvinar eros. Quisque interdum in elit quis bibendum. Morbi tempus, dolor vitae euismod finibus, tellus neque rutrum tortor, ut finibus tortor libero vel quam. Sed ac leo eu ex blandit ultrices. Donec aliquam, ipsum at posuere lobortis, ipsum velit blandit erat, semper auctor dui lorem non arcu. Praesent sapien diam, sagittis vitae nunc et, fringilla molestie metus. Ut egestas, sem id interdum cursus, nibh tellus tincidunt lorem, vitae euismod purus urna pellentesque est. Maecenas bibendum tortor pellentesque magna ultrices efficitur. Cras scelerisque, risus eu accumsan aliquam, justo neque euismod tellus, sed euismod turpis purus aliquam enim. Quisque commodo, sem id pretium volutpat, mauris orci scelerisque nulla, ac sollicitudin erat augue sed nibh. Curabitur tellus nulla, lacinia nec eros sed, cursus pulvinar eros. Phasellus ornare mauris at nibh rhoncus, congue viverra libero suscipit. Pellentesque commodo ultricies leo, eget interdum nibh vulputate eu.</p>
        </div> 
    );
}
}
